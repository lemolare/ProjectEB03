...
/**
 * Activité qui assure la gestion de la connexion bluetooth
 */
...
public class BTConnectActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    /**
     * methode qui permet de lancer ou d'arréter la detection des périphériques
     */
    ...
    /**
     * Méthode qui permet de scanner les périphériques
     * @param startstop
     */
